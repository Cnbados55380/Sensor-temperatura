...
/* USER CODE BEGIN 0 */
	...
	static uint8_t T_min = 15 , T_max = 40 ; //Se definen unos márgenes de funcionamiento que se pueden cambiar
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  if(debouncer(&Seleccion_estado, GPIOA, GPIO_PIN_0)){ //Estado para la eleccion de la temperatura de control. NO ESCRIBIR AQUÍ
