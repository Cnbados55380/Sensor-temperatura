...
#define V25 0.76 /* Sensor's voltage at 25 °C */
#define AVG_SLOPE 0.0025 /* V (2.5mV/°C) */
  ...
  while (1)
  {
	  if(AdcConvCmplt){
		 ...
		 double Temperature = (VTmpSens - V25)/(AVG_SLOPE) + 25.0;
    ...
    /* USER CODE BEGIN 3 */
 	  if (Temperature <= 20)
	  	  		  ...
	  	  		  HAL_GPIO_WritePin(GPIOD,GPIO_PIN_15,GPIO_PIN_RESET); // Azul
	  	  		  HAL_GPIO_WritePin(GPIOD,GPIO_PIN_14,GPIO_PIN_RESET); // Rojo
	  	  		  HAL_GPIO_WritePin(GPIOD,GPIO_PIN_13,GPIO_PIN_RESET); // Naranja
